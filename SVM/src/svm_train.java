...
class svm_train {
	...
	public svm_problem getInputDataSet(){
		return prob;
	}
	...
	public svm_problem read_problem_with_file(String input_file_name, double alpha) throws  IOException{
		this.input_file_name = input_file_name;
		this.param = new svm_parameter();
		this.param.gamma = alpha;
